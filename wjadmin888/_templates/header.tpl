...
<body>
	...
	{if $isAuthenticated == 1}
     ...
     <li><a href="{$BASE_URL_ADMIN}links/footer4/">Footer Column 4</a></li>
	 </ul>
	 </li>
	 ...
	 <li>
	    <a href="#">附加功能</a>
	   <ul>
	        <li class="right bold"><a href="{$BASE_URL_ADMIN}logout/">安全退出</a></li> 
	        <li><a href="{$BASE_URL_ADMIN}jobsetting">职位设置</a></li>
            <li><a href="{$BASE_URL_ADMIN}links/footer4/">Footer Column 4</a></li>
	   </ul>
	 </li>
	 </ul>
