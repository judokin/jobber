	...
	<form id="publish_form" class="add_page" action="{$smarty.server.REQUEST_URI}" method="post">
		<div class="left span2 block">
			...
			<div class="block_inner">
				...
				<div class="group">
					<label for="is_active">is_active?(0|1)</label>
					<input type="text" name="is_active" id="is_active" class="text_field" size="35" value="{$defaults.is_active}" />
				</div>
				<!--  	create_on  -->
				<div class="group">
					<label for="create_on">create_on</label>
					<input type="text" name="create_on" id="create_on" class="text_field" size="35" value="{if $defaults.create_on }{$defaults.create_on}{else}{php}echo date('Y-m-d H:i:s');{/php}{/if}" />
				</div>
			    <!-- active_on -->	
				<div class="group">
					<label for="active_on">active_on</label>
					<input type="text" name="active_on" id="active_on" class="text_field" size="35" value="{$defaults.active_on}" />
				</div>
				<!-- links -->	
				<div class="group">
					<label for="active_on">link_on</label>
				    {$option}
				</div>
