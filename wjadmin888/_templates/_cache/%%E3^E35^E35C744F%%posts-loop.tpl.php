<?php /* Smarty version 2.6.26, created on 2013-04-24 10:52:25
...
<?php endif; ?>
 ...
 times<?php if ($this->_tpl_vars['statisticalData'][$this->_tpl_vars['job']['id']]): ?>, 
			<?php echo $this->_tpl_vars['statisticalData'][$this->_tpl_vars['job']['id']]['numberOfApplications']; ?>
 applicants, 
			last application on <?php echo $this->_tpl_vars['statisticalData'][$this->_tpl_vars['job']['id']]['lastApplicationOn']; ?>
<?php endif; ?>
			<?php if ($this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]): ?>,
			<span class="spam"> reported as spam <?php echo $this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]['numberOfSpamReports']; ?>
 times, 
			last time on <?php echo $this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]['lastSpamReportOn']; ?>
</span>
			<?php endif; ?>
			&nbsp;&nbsp;<a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
jobhits/<?php echo $this->_tpl_vars['job']['id']; ?>
">增加一个view</a>
			&nbsp;&nbsp;<a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
jobapp/<?php echo $this->_tpl_vars['job']['id']; ?>
">增加一个申请</a>
		</div>
	</div>
