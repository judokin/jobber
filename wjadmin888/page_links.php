<?php
	...
	if ($id == 'primary' || $id == 'secondary' || $id == 'footer1' || $id == 'footer2' || $id == 'footer3' || $id == 'footer4') $menu = $id;
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST' && key_exists('action', $_POST)) {
		switch ($_POST['action']) {
			case 'saveOrder':
				...
				break;
			case 'newLink':
				if ($id == 'primary' || $id == 'secondary' || $id == 'footer1' || $id == 'footer2' || $id == 'footer3' || $id == 'footer4')	$menu_id = $id; else $menu_id = 'primary'; 
	...
	if (isset($menu) && $menu != '0')
	{
		...
		elseif ($menu == 'footer4') $menu_name = 'Footer Column 4';
