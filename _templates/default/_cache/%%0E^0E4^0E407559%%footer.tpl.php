...
" ><?php echo $this->_tpl_vars['navigation']['footer3'][$this->_sections['tmp']['index']]['name']; ?>
            ...
            <div id="footer-col4">
				<?php echo $this->_tpl_vars['translations']['footer']['friend_link']; ?>
:<br />
				<?php if ($this->_tpl_vars['navigation']['footer4'] != ''): ?>
					<?php unset($this->_sections['tmp']);
$this->_sections['tmp']['name'] = 'tmp';
$this->_sections['tmp']['loop'] = is_array($_loop=$this->_tpl_vars['navigation']['footer4']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['tmp']['show'] = true;
$this->_sections['tmp']['max'] = $this->_sections['tmp']['loop'];
$this->_sections['tmp']['step'] = 1;
$this->_sections['tmp']['start'] = $this->_sections['tmp']['step'] > 0 ? 0 : $this->_sections['tmp']['loop']-1;
...
$this->_sections['tmp']['last']       = ($this->_sections['tmp']['iteration'] == $this->_sections['tmp']['total']);
?>
						<?php if (@ENABLE_NEW_JOBS || ( ! @ENABLE_NEW_JOBS && $this->_tpl_vars['navigation']['footer4'][$this->_sections['tmp']['index']]['url'] != 'post' )): ?>
							<a target="_blank" href="<?php if ($this->_tpl_vars['navigation']['footer4'][$this->_sections['tmp']['index']]['outside'] != 1): ?><?php echo $this->_tpl_vars['BASE_URL']; ?>
<?php endif; ?><?php echo $this->_tpl_vars['navigation']['footer4'][$this->_sections['tmp']['index']]['url']; ?>
/" title="<?php echo $this->_tpl_vars['navigation']['footer4'][$this->_sections['tmp']['index']]['title']; ?>
" ><?php echo $this->_tpl_vars['navigation']['footer4'][$this->_sections['tmp']['index']]['name']; ?>
</a><br />
						<?php endif; ?>
					<?php endfor; endif; ?>
				<?php endif; ?>
