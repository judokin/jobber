<?php /* Smarty version 2.6.26, created on 2010-12-09 20:09:42
...
/img/icon-delete.png" alt="" />
				...
				<section id="apply-online" <?php if ($_SESSION['apply_successful'] && $_SESSION['apply_successful'] == -1): ?>style="display: block;"<?php else: ?>style="display: none;"<?php endif; ?>>
					<form id="frm-apply-online" method="post" enctype="multipart/form-data" action="<?php echo $this->_tpl_vars['BASE_URL']; ?>
apply-online/">
						<fieldset>
							<label for="apply_name"><?php echo $this->_tpl_vars['translations']['apply']['name_label']; ?>
:</label> <br />
...
" placeholder="First and last name" required autofocus /><br />
							<span class="validation-error"><?php if ($_SESSION['apply_errors']['apply_name']): ?><img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
img/icon-delete.png" alt="" width="16" height="16" /><?php endif; ?></span>
							
							<label for="apply_email"><?php echo $this->_tpl_vars['translations']['apply']['email_label']; ?>
:</label><br />
							<input <?php if ($_SESSION['apply_errors']['apply_email']): ?>class="error"<?php endif; ?> type="email" name="apply_email" id="apply_email" maxlength="50" size="30" value="<?php echo $_SESSION['apply_fields']['apply_email']; ?>
" placeholder="name@domain.co.uk" required /><br />
							<span class="validation-error"><?php if ($_SESSION['apply_errors']['apply_email']): ?><img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
img/icon-delete.png" alt="" width="16" height="16" /><?php endif; ?></span>	
							
							<label for="apply_msg"><?php echo $this->_tpl_vars['translations']['apply']['message_label']; ?>
:</label><br />
							<textarea <?php if ($_SESSION['apply_errors']['apply_msg']): ?>class="error"<?php endif; ?> name="apply_msg" id="apply_msg" cols="60" rows="15" placeholder="Your message here" ><?php echo $_SESSION['apply_fields']['apply_msg']; ?>
</textarea><br />
							<span class="validation-error"><?php if ($_SESSION['apply_errors']['apply_msg']): ?><img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
img/icon-delete.png" alt="" width="16" height="16" /><?php endif; ?></span>
							
							<label for="apply_cv"><?php echo $this->_tpl_vars['translations']['apply']['cv_label']; ?>
:</label><br />
							<input type="file" name="apply_cv" id="apply_cv" /><br />
							<span class="validation-error"><?php if ($_SESSION['apply_errors']['apply_cv']): ?><img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
img/icon-delete.png" alt="" width="16" height="16" /><?php endif; ?></span>
							
							<section class="suggestion">Maximum 3 <abbr title="MegaBytes">MB</abbr>. Recommended formats: <abbr title='Portable Document Format'>PDF</abbr>, <abbr title='Rich Text Format'>RTF</abbr>, <abbr title='Document'>DOC</abbr>, <abbr title='OpenDocument Text'>ODT</abbr>.</section>
...
<?php endif; ?></span>
								...
								<?php endif; ?>
<input type="submit" name="submit" id="submit2" value="<?php echo $this->_tpl_vars['translations']['apply']['submit']; ?>
" /> <?php echo $this->_tpl_vars['translations']['apply']['or']; ?>

							<a href="#" onclick="$('#apply-online').toggle(); window.location.href = '#'; return false;"><?php echo $this->_tpl_vars['translations']['apply']['cancel']; ?>
</a>
...
" />
				...
				</section><!-- #apply-online -->				<?php endif; ?>
