<?php /* Smarty version 2.6.26, created on 2010-12-09 20:08:51
...
:</label><br />
						<input <?php if ($this->_tpl_vars['errors']['title']): ?>class="error"<?php endif; ?> type="text" name="title" id="title" tabindex="2" size="50" value="<?php if ($this->_tpl_vars['job']['company']): ?><?php echo $this->_tpl_vars['job']['title']; ?>
<?php else: ?><?php echo $_POST['title']; ?>
<?php endif; ?>" placeholder="Office administrator" required />
						<?php if ($this->_tpl_vars['errors']['title']): ?><span class="validation-error"><img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
img/icon-delete.png" alt="" /></span><?php endif; ?>			<br />

						<section class="<?php echo $this->_tpl_vars['translations']['publish']['title_info']; ?>
"></section>
...
" <?php if ($_POST['city_id'] == $this->_tpl_vars['cities'][$this->_sections['c']['index']]['id'] || $this->_tpl_vars['job']['city_id'] == $this->_tpl_vars['cities'][$this->_sections['c']['index']]['id']): ?>selected="selected"<?php else: ?><?php if ($this->_tpl_vars['user_city']['id'] == $this->_tpl_vars['cities'][$this->_sections['c']['index']]['id'] && ! $_POST['city_id'] && ! $this->_tpl_vars['job']['city_id']): ?>selected="selected"<?php endif; ?><?php endif; ?>><?php if ($this->_tpl_vars['cities'][$this->_sections['c']['index']]['id'] == -1): ?>-- <?php echo $this->_tpl_vars['cities'][$this->_sections['c']['index']]['name']; ?>
 --<?php else: ?><?php echo $this->_tpl_vars['cities'][$this->_sections['c']['index']]['name']; ?>
<?php endif; ?></option>
							<?php endfor; endif; ?>
						</select>
						<p id="other_location_label" >or <a href="#" onclick="Jobber.HandleLocationOutsideRo(); return false;"><?php if ($this->_tpl_vars['job']['location_outside_ro'] != '' || $_POST['location_outside_ro_where'] != ''): ?><?php echo $this->_tpl_vars['translations']['publish']['location_pick_from_list']; ?>
...
<?php endif; ?></a></p>
						...
						<div id="location_outside_ro" <?php if ($this->_tpl_vars['job']['location_outside_ro'] != '' || $_POST['location_outside_ro_where'] != ''): ?>style="display: block;"<?php else: ?>style="display: none;"<?php endif; ?>>
							<label><?php echo $this->_tpl_vars['translations']['publish']['where']; ?>
</label><br />
							<input type="text" name="location_outside_ro_where" id="location_outside_ro_where" size="50" maxlength="140" <?php if ($this->_tpl_vars['job']['location_outside_ro'] != ''): ?>value="<?php echo $this->_tpl_vars['job']['location']; ?>
"<?php endif; ?><?php if ($_POST['location_outside_ro_where'] != ''): ?>value="<?php echo $_POST['location_outside_ro_where']; ?>
"<?php endif; ?> />
						</div>
						
						<label for="description"><?php echo $this->_tpl_vars['translations']['publish']['description_label']; ?>
:</label><br />
						<textarea <?php if ($this->_tpl_vars['errors']['description']): ?>class="error"<?php endif; ?> tabindex="4" name="description" id="description" cols="80" rows="15" placeholder="First and last name" required ><?php if ($this->_tpl_vars['job']['company']): ?><?php echo $this->_tpl_vars['job']['description']; ?>
...
img/icon-delete.png" alt="" /></span><?php endif; ?>
						...
						<section class="suggestion">
							<p><a href="http://www.textism.com/tools/textile/" onclick="$('#textile-suggestions').toggle(); return false;"><?php echo $this->_tpl_vars['translations']['publish']['description_info']; ?>
</a></p>
						</section>
				...
				<fieldset>
					...
					<label class="publish-label"><?php echo $this->_tpl_vars['translations']['publish']['name_label']; ?>
:</label><br />
					<input <?php if ($this->_tpl_vars['errors']['company']): ?>class="error"<?php endif; ?> tabindex="6" type="text" name="company" id="company" size="40" value="<?php if ($this->_tpl_vars['job']['company']): ?><?php echo $this->_tpl_vars['job']['company']; ?>
<?php else: ?><?php echo $_POST['company']; ?>
<?php endif; ?>" placeholder="First and last names" required />
...
img/icon-delete.png" alt="" /><?php endif; ?></span>
					<br />
					<label><?php echo $this->_tpl_vars['translations']['publish']['website_label']; ?>
:</label><br />
					<input tabindex="7" type="url" name="url" id="url" size="35" value="<?php if ($this->_tpl_vars['job']['company']): ?><?php echo $this->_tpl_vars['job']['url']; ?>
<?php else: ?><?php echo $_POST['url']; ?>
<?php endif; ?>" placeholder="www.domain.co.uk" required />
					<br/>
					<section class="suggestion"><?php echo $this->_tpl_vars['translations']['publish']['website_info']; ?>
</section>
				
					<label class="publish-label"><?php echo $this->_tpl_vars['translations']['publish']['email_label']; ?>
 (<?php echo $this->_tpl_vars['translations']['publish']['email_info1']; ?>
):</label><br />
					<input <?php if ($this->_tpl_vars['errors']['poster_email']): ?>class="error"<?php endif; ?> tabindex="8" type="email" name="poster_email" id="poster_email" size="40" value="<?php if ($this->_tpl_vars['job']['poster_email']): ?><?php echo $this->_tpl_vars['job']['poster_email']; ?>
<?php else: ?><?php echo $_POST['poster_email']; ?>
<?php endif; ?>" placeholder="name@domain.co.uk" required />
					<span class="validation-error"><?php if ($this->_tpl_vars['errors']['poster_email']): ?><img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
img/icon-delete.png" alt="" /><?php endif; ?></span>
					<br />
					<section class="suggestion">
						<p><?php echo $this->_tpl_vars['translations']['publish']['email_info2']; ?>
</p>
					</section>
				</fieldset>
