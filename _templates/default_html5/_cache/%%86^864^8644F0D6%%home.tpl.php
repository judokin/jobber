<?php /* Smarty version 2.6.26, created on 2010-12-09 19:59:21
...
<?php if ($this->_tpl_vars['latest_jobs']): ?>
    ...
    foreach ($_from as $this->_tpl_vars['job']):
?>
		<section class="<?php echo smarty_function_cycle(array('values' => 'row,row-alt'), $this);?>
">
			<span class="row-info">
				<img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
